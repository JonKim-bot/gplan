...
<div class="col-md-12 d-flex align-items-center">
        <div class="c-form" style="width:100%">
            <form role="form" method="POST" enctype="multipart/form-data" action="<?= base_url('/API/reset_password_function'); ?>">
            ...
            Password</button>
                    ...
                    <tr>
                        <td style="text-align:center;">
                            <p style="font-size:14px; color:rgba(69, 80, 86, 0.7411764705882353); line-height:18px; margin:0 0 0;">&copy; <strong>www.lcelebs.com.my</strong></p>
                        </td>
                    </tr>
                    <tr>
                        <td style="height:80px;">&nbsp;</td>
