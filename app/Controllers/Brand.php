...
class Brand extends BaseController
{
    ...
    public function add()
    {
        if ($_POST) {
            ...
            if (!$error) {
                ...
                $data = $this->upload_image_with_data($data, 'logo');
                // dd($data);
    ...
    public function detail($brand_id)
    {
        ...
        $model = $this->ModelModel->getWhere(['model.brand_id' => $brand_id]);
        // dd($model);.
        $this->pageData['model'] = $model;
        $field = $this->ModelModel->get_field(
            ['model_id', 'created_by', 'modified_by', 'deleted', 'brand_id'],
            $model
        );
        $this->pageData['table_model'] = $this->generate_table(
            $field,
            $model,
            'model',
            'banner',
        ...
        $this->pageData[
            'final_form_model'
        ] = $this->ModelModel->get_final_form_add([
            'created_by',
            'modified_by',
            'deleted',
            'modified_date',
