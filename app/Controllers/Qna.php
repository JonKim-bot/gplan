...
class Qna extends BaseController
{
    ...
    public function index()
    {
        ...
        $field = $this->QnaModel->get_field(
            ['created_by', 'modified_by', 'deleted', 'qna_type_id', 'qna_id'],
            $qna
        );
    ...
    {
        $qna = $this->QnaModel->copy($qna_id, ['qna_type']);
    ...
    public function detail($qna_id)
    {
        ...
        $this->pageData['qna'] = $qna[0];

        $field = $this->QnaModel->get_field(
            ['created_by', 'modified_by', 'deleted', 'qna_id', 'qna_type_id'],
            $qna
        );
