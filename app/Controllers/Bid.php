...
class Bid extends BaseController
{
    ...
    public function add()
    {
        ...
        $this->pageData['form'] = $this->BidModel->generate_input();
        ...
        $this->pageData['auction'] = $this->AuctionModel->getAll();
    ...
    {
        $bid = $this->BidModel->copy($bid_id, ['users', 'model', 'plate_no']);
        return redirect()->to(base_url('Bid', 'refresh'));
    }
