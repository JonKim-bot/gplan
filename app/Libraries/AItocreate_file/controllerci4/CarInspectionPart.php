...
class CarInspectionPart extends BaseController
{
    ...
    public function index()
    {
        ...
        $field = $this->CarInspectionPartModel->get_field([
            'created_by',
            'modified_by',
            'deleted',
        ]);
    ...
    public function add()
    {
        ...
        $this->pageData[
            'final_form'
        ] = $this->CarInspectionPartModel->get_final_form_add([
            'created_by',
            'modified_by',
            'deleted',
            'modified_date',
    ...
    {
        $car_inspection_part = $this->CarInspectionPartModel->copy(
            $car_inspection_part_id
        );
        return redirect()->to(base_url('CarInspectionPart', 'refresh'));
    }
    ...
    {
        $where = [
            'car_inspection_part_id' => $car_inspection_part_id,
        ];
        $car_inspection_part = $this->CarInspectionPartModel->getWhere(
            $where
        )[0];
        $this->pageData['car_inspection_part'] = $car_inspection_part;
    ...
    public function edit($car_inspection_part_id)
    {
        ...
        $this->pageData[
            'car_inspection_part'
        ] = $this->CarInspectionPartModel->getWhere($where)[0];
        ...
        if ($_POST) {
            ...
            if (!$error) {
                ...
                return redirect()->to(
                    base_url(
                        'CarInspectionPart/detail/' . $car_inspection_part_id,
                        'refresh'
                    )
                );
            }
        ...
        $this->pageData[
            'final_form'
        ] = $this->CarInspectionPartModel->get_final_form_edit(
            $car_inspection_part_id,
            [
                'created_by',
                'modified_by',
